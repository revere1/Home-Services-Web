    ...
    */
    ...
    var Buttons = /** @class */ (function () {
        ...
        Buttons.prototype.addToolbarButtons = function () {
            ...
            this.context.memo('button.links', function () {
                return _this.button({
            ...
            this.context.memo('button.caption', function () {
                return _this.button({
                    contents: 'caption',
                    tooltip: _this.lang.caption.caption + _this.representShortcut('justifyCenter'),
                    click: _this.context.createInvokeHandler('editor.justifyCenter')
                }).render();
            });
    ...
    $$1.summernote = $$1.extend($$1.summernote, {
        ...
        options: {
            ...
            container: 'body',
            maxTextLength: 0,
            styleTags: ['p', 'blockquote', 'pre', 'h3', 'caption', 'highlight'],
            fontNames: [
        ...
        $.extend($.summernote.plugins, {
            ...
            'addclass': function (context) {
                ...
                if (typeof context.options.addclass.classTags === 'undefined') {
                    context.options.addclass.classTags = ["jumbotron"];
                    context.options.addclass.classTagLabels = { "jumbotron": "Highlight" };
                    ...
                    return ui.buttonGroup([
                        ...
                        ui.dropdown({
                            ...
                            template: function (item) {
                                ...
                                return '<' + tag + ' ' + style + cssclass + '>' + context.options.addclass.classTagLabels[title] + '</' + tag + '>';
                            },
